...
#> 1 FALSE 1105021 Curling ~ curling-mi~       32124 Helen Stewart  <df[,59] [2 x ~
#> 2 FALSE 1109817 Pink Lem~ pink-lemon~       72078 Amy Rapp       <df[,59] [2 x ~
#> 3 FALSE 1121082 Senbonza~ senbonzaku~       31024 Natalia Vasil~ <df[,59] [2 x ~
...
#>  $ difficulty_count       : int 770
#>  $ downloadable           : logi TRUE
#>  $ favorites_count        : int 14945
#>  $ free                   : logi TRUE
#>  $ gauge                  : num 32
#>  $ gauge_divisor          : int 4
...
#>  $ price                  : chr ""
#>  $ projects_count         : int 3550
#>  $ published              : chr "2018/12/01"
#>  $ queued_projects_count  : int 2126
#>  $ rating_average         : num 4.81
#>  $ rating_count           : int 795
#>  $ row_gauge              : num 46
